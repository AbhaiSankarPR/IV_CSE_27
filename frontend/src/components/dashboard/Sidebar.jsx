export default function Sidebar({
  ...
  return (
   <div
  className={`fixed top-[77px] left-0 h-screen overflow-y-auto bg-black/30 backdrop-blur-md border-r border-white/10 p-5 flex flex-col gap-6 md:w-80 w-full transition-all duration-300 ${
...
>
      ...
      >
        <div>
          <p className="font-semibold font-caveat text-3xl">
            {user?.name || "User"}
          </p>
