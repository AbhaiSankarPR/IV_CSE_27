        ...
        <div className={`flex flex-col gap-2 mt-2 ${sidebarOpen ? "block" : "hidden md:block"}`}>
          <button
            ...
            className={`p-3 rounded-lg text-left text-sm transition ${
              activeTab === "essentials" ? "bg-white/20 text-white font-medium" : "hover:bg-white/10 text-white"
            }`}
          >
            IV Essentials
          </button>
          ...
          <button
            ...
            className={`p-3 rounded-lg text-left text-sm transition ${
              activeTab === "upload" ? "bg-white/20 text-white font-medium" : "hover:bg-white/10 text-white"
            }`}
          >
            Upload Image
          </button>
          ...
          <button
            ...
            className={`p-3 rounded-lg text-left text-sm transition ${
              activeTab === "expenses" ? "bg-white/20 text-white font-medium" : "hover:bg-white/10 text-white"
            }`}
          >
            Expense Details
          </button>
