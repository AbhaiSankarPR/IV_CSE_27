...
export default function Signup({ onToggleMode }) {
  ...
  return (
    <div className="w-full">
      <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-center">Create Account</h2>
      ...
      <form className="space-y-4" onSubmit={handleSubmit(onSignupSubmit)}>
        ...
        <button
          ...
          className={`w-full py-3 rounded font-semibold transition ${!isValid || loading ? "bg-gray-600 cursor-not-allowed" : "bg-green-500 text-black hover:bg-green-400"
            }`}
        >
